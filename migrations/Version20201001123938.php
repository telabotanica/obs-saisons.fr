 ...
 */
final class Version20201001123938 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE stade_bbch bbch_code INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE bbch_code stade_bbch INT DEFAULT NULL');
    }
}
