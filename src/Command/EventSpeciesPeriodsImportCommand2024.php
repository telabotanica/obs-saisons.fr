...
class EventSpeciesPeriodsImportCommand2024 extends Command
{
    protected static $defaultName = 'ods:import:periods2024';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $speciesPeriods = (new HandleCsvFile())->parseCsv('src/Ressources/calendar_periods_2024.csv');
