...
class OdsImportFeaturedSpeciesDatesCommand2024 extends Command
{
    protected static $defaultName = 'ods:import:featured-species-dates2024';
    ...
    {
        $featuredData = (new HandleCsvFile())->parseCsv('src/Ressources/ods_featured_dates_2024.csv');
