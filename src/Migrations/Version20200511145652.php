 ...
 */
final class Version20200511145652 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE species DROP FOREIGN KEY FK_A50FF712E85F12B8');
        $this->addSql('DROP INDEX IDX_A50FF712E85F12B8 ON species');
        $this->addSql('ALTER TABLE species ADD post_id INT DEFAULT NULL, DROP post_id_id, CHANGE picture picture VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE species ADD CONSTRAINT FK_A50FF7124B89032C FOREIGN KEY (post_id) REFERENCES post (id)');
        $this->addSql('CREATE INDEX IDX_A50FF7124B89032C ON species (post_id)');
        ...
        $this->addSql('ALTER TABLE observation CHANGE user_id user_id INT DEFAULT NULL, CHANGE picture picture VARCHAR(255) DEFAULT NULL, CHANGE details details VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE individual CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE observation CHANGE user_id user_id INT DEFAULT NULL, CHANGE picture picture VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE details details VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('DROP INDEX IDX_A50FF7124B89032C ON species');
        $this->addSql('ALTER TABLE species ADD post_id_id INT DEFAULT NULL, DROP post_id, CHANGE picture picture VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE species ADD CONSTRAINT FK_A50FF712E85F12B8 FOREIGN KEY (post_id_id) REFERENCES post (id)');
        $this->addSql('CREATE INDEX IDX_A50FF712E85F12B8 ON species (post_id_id)');
